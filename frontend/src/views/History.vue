          ...
          >
            ...
            <div class="news-content">
              ...
              <div class="news-meta">
                ...
                <span class="time">浏览于 {{ formatTime(item.viewTime) }}</span>
                <span class="views">{{ item.views || 0 }} 阅读</span>
              </div>
            </div>
            <button 
              class="delete-btn" 
              @click.stop="handleDelete(item.historyId)"
              title="删除记录"
            >
              &times;
            </button>
...
import { getHistoryList, deleteHistory, clearHistory } from '@/services/api'
