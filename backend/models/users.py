...
from sqlalchemy import ForeignKey, Index, Integer, String, Enum, DateTime
...
class User(Base):
    ...
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now, onupdate=datetime.now, comment="创建时间")
